...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry_1_calc = customtkinter.CTkEntry(self.calc_frame, placeholder_text="Число 1", width=100)
        ...
        self.entry_1_calc.bind("<Return>", lambda event: self.res_calc(event,one=self.entry_1_calc.get(),two=self.entry_2_calc.get()))
    ...
    def res_calc(self, event="", one=1, two=1):
